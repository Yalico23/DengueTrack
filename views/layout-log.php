...
<meta charset="UTF-8">
    ...
    <link rel="canonical" href="https://yalicodev.online/user/login">
    ...
    <meta property="og:url" content="https://yalicodev.online/user/login">
...
<body>
    <?php echo $contenido; ?>
    <?php require __DIR__ . '/templates/news.php' ?>
