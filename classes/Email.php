...
class Email{
    ...
    public function EnviarConfirmacion()
    {
        ...
        $mail->addAddress($this->email, 'DengueTrack.com'); //para quien
        ...
        $contenido = "<html>
                ...
                <body>
                    ...
                    <p>Has creado tu cuenta en DengueTrack. Para confirmar tu cuenta, por favor presiona el siguiente enlace:</p>
                    <p><a href='" . $_ENV['PROJECT_URL'] . "/user/confirmar?token=" . $this->token . "'>Confirmar Cuenta</a></p>
    ...
    public function enviarInstrucciones()
    {
        ...
        $contenido = "<html>
                ...
                <body>
                    ...
                    <p><a href='" . $_ENV['PROJECT_URL'] . "/user/recuperar?token=" . $this->token . "'>Restablecer contraseña</a></p>
